...
must_haves:
  truths:
    - "AI providers can accept game-specific question requests with difficulty and slide context"
    - "Difficulty is calibrated to educational Bloom's taxonomy (easy=recall, medium=apply, hard=analyze)"
    - "Slide context captures cumulative lesson content for question generation"
    - "All game types share consistent request/response contracts"
  artifacts:
