...
must_haves:
  truths:
    ...
    - "Both Gemini and Claude providers produce scaffolded output"
...
Both Gemini and Claude providers produce equivalent scaffolded output when given lesson content with teachable moments.
</success_criteria>
