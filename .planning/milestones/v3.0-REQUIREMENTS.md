# Requirements Archive: v3.0 Quiz Game Variety
...
- [x] **VIEW-01**: Game board displays on student view (projector) via BroadcastChannel
- [x] **VIEW-02**: Answer options hidden until teacher reveals
- [x] **VIEW-03**: Timer displays visible on student view
- [x] **VIEW-04**: Current game state clear (whose turn, scores, positions)
...
**Shipped:** 42 of 42 v3.0 requirements
